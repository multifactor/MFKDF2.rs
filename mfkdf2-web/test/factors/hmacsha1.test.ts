...
suite('factors/hmacsha1', () => {
  ...
  test('dynamic', async () => {
    ...
    const derive1 = await mfkdf.derive.key(setup.policy, {
      hmacsha1: await mfkdf.derive.factors.hmacsha1(response1)
    });
  ...
  test('static', async () => {
    ...
    const derive = await mfkdf.derive.key(
      JSON.parse(setup),
      {
        hmacsha1: await mfkdf.derive.factors.hmacsha1(
  ...
  test('wrong-salt', async () => {
    const setup =
      '{"$schema":"https://mfkdf.com/schema/v2.0.0/policy.json","$id":"8b6874f7-5dbb-4196-bc89-347cd6b02dc6","size":32,"threshold":1,"key":"LPJNul+wow4m6DsqxbninhsWHlwfp0JecwQzYpOLmCQ=","salt":"nhh2/3AwOf2r2n7uRONoM697IjEKsHfAeyo8NxF1G94=","factors":[{"id":"hmacsha1","type":"hmacsha1","pad":"RvNBkCLB7QPY2DkTl8tra0QGxiBjqvE12gEP00i5c+y+1pmcyqqLYDgVLxmvGu+L","salt":"PlS1B6fPovsuMfKZinw6hn0kTw1VEpoM8jRFR/8SyT0=","params":{"challenge":"5a5f71c3a584b797d3c8f7d0f59653a2234781b06f2540df42946aa380f634a3430e6aad294e392543cc4ecd3da039bfa8041b179d14afd360a104e3354f01dd","pad":"9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08"}}]}';
    ...
    const setup2 =
      '{"$schema":"https://mfkdf.com/schema/v2.0.0/policy.json","$id":"8b6874f7-5dbb-4196-bc89-347cd6b02dc6","size":32,"threshold":1,"key":"LPJNul+wow4m6DsqxbninhsWHlwfp0JecwQzYpOLmCQ=","salt":"nhh2/3AwOf2r2n7uRONoM697IjEKsHfAeyo8NxF1G94=","factors":[{"id":"hmacsha1","type":"hmacsha1","pad":"RvNBkCLB7QPY2DkTl8tra0QGxiBjqvE12gEP00i5c+y+1pmcyqqLYDgVLxmvGu+L","salt":"PsS1B6fPovsuMfKZinw6hn0kTw1VEpoM8jRFR/8SyT0=","params":{"challenge":"5a5f71c3a584b797d3c8f7d0f59653a2234781b06f2540df42946aa380f634a3430e6aad294e392543cc4ecd3da039bfa8041b179d14afd360a104e3354f01dd","pad":"9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08"}}]}';
  ...
  suite('errors', () => {
    /* invalid test - setup.factors.hmacsha1 doesn't exist in current API
    test('id/type', async () => {
