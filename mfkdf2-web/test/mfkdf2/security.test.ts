  ...
  suite('factor-fungibility', () => {
    ...
    test('incorrect', async () => {
      ...
      const derive = await mfkdf.policy.derive(
        setup.policy,
        {
          password1: await mfkdf.derive.factors.password('password2'),
          password2: await mfkdf.derive.factors.password('password1')
        },
        false
      )
  ...
  suite('share-encryption', () => {
    test('correct', async () => {
      ...
      const derive2 = await mfkdf.policy.derive(derive.policy, {
        password1: await mfkdf.derive.factors.password('newPassword1'),
        password2: await mfkdf.derive.factors.password('password2')
      })
      ...
      const derive3 = await mfkdf.policy.derive(derive2.policy, {
        password1: await mfkdf.derive.factors.password('newPassword2'),
        password2: await mfkdf.derive.factors.password('password2')
      })
  ...
  suite('timing-oracle', () => {
    suite('totp/dynamic', async () => {
      ...
      test('valid-fixed-oracle', async () => {
        ...
        const derive1 = await mfkdf.derive.key(setup.policy, {
          totp: await mfkdf.derive.factors.totp(code, { oracle })
        })
      ...
      test('invalid-fixed-oracle', async () => {
        ...
        const derive1 = await mfkdf.derive.key(
          setup.policy,
          {
            totp: await mfkdf.derive.factors.totp(code, { oracle: oracle2 })
          },
          false
        )
    ...
    suite('totp/static', async () => {
      ...
      test('valid-fixed-oracle', async () => {
        ...
        const derive1 = await mfkdf.derive.key(setup.policy, {
          totp: await mfkdf.derive.factors.totp(953265, {
            time: 1,
            oracle
          })
        })
        ...
        const derive2 = await mfkdf.derive.key(derive1.policy, {
          totp: await mfkdf.derive.factors.totp(241063, {
            time: 30001,
            oracle
          })
        })
        ...
        const derive3 = await mfkdf.derive.key(derive1.policy, {
          totp: await mfkdf.derive.factors.totp(361687, {
            time: 60001,
            oracle
          })
        })
      ...
      test('invalid-fixed-oracle', async () => {
        ...
        const derive1 = await mfkdf.derive.key(
          setup.policy,
          {
            totp: await mfkdf.derive.factors.totp(528258, {
              time: 1650430943604,
              oracle: oracle2
            })
          },
        ...
        const derive2 = await mfkdf.derive.key(
          derive1.policy,
          {
            totp: await mfkdf.derive.factors.totp(99922, {
              time: 1650430991083,
              oracle: oracle2
            })
          },
        ...
        const derive3 = await mfkdf.derive.key(
          derive1.policy,
          {
            totp: await mfkdf.derive.factors.totp(398884, {
              time: 1650431018392,
              oracle: oracle2
            })
          },
