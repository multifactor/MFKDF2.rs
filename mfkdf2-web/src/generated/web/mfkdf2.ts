...
export async function deriveKey(
  policy: Policy,
  factors: Map<string, Mfkdf2Factor>,
  asyncOpts_?: { signal: AbortSignal },
): Promise<Mfkdf2DerivedKey> /*throws*/ {
  const __stack = uniffiIsDebug ? new Error().stack : undefined;
  try {
    return await uniffiRustCallAsync(
      /*rustCaller:*/ uniffiCaller,
      /*rustFutureFunc:*/ () => {
        return nativeModule().ubrn_uniffi_mfkdf2_fn_func_derive_key(
          FfiConverterTypePolicy.lower(policy),
          FfiConverterMapStringTypeMFKDF2Factor.lower(factors),
        );
      },
      /*pollFunc:*/ nativeModule().ubrn_ffi_mfkdf2_rust_future_poll_rust_buffer,
      /*cancelFunc:*/ nativeModule()
        .ubrn_ffi_mfkdf2_rust_future_cancel_rust_buffer,
      /*completeFunc:*/ nativeModule()
        .ubrn_ffi_mfkdf2_rust_future_complete_rust_buffer,
      /*freeFunc:*/ nativeModule().ubrn_ffi_mfkdf2_rust_future_free_rust_buffer,
      /*liftFunc:*/ FfiConverterTypeMFKDF2DerivedKey.lift.bind(
        FfiConverterTypeMFKDF2DerivedKey,
      ),
      /*liftString:*/ FfiConverterString.lift,
      /*asyncOpts:*/ asyncOpts_,
      /*errorHandler:*/ FfiConverterTypeMFKDF2Error.lift.bind(
...
export function derivePassword(password: string): Mfkdf2Factor /*throws*/ {
  return FfiConverterTypeMFKDF2Factor.lift(
    uniffiCaller.rustCallWithError(
      /*liftError:*/ FfiConverterTypeMFKDF2Error.lift.bind(
        FfiConverterTypeMFKDF2Error,
      ),
      /*caller:*/ (callStatus) => {
...
export async function key(
  ...
  try {
    return await uniffiRustCallAsync(
      /*rustCaller:*/ uniffiCaller,
      /*rustFutureFunc:*/ () => {
        return nativeModule().ubrn_uniffi_mfkdf2_fn_func_key(
          FfiConverterArrayTypeMFKDF2Factor.lower(factors),
          FfiConverterTypeMFKDF2Options.lower(options),
        );
      },
      /*pollFunc:*/ nativeModule().ubrn_ffi_mfkdf2_rust_future_poll_rust_buffer,
      /*cancelFunc:*/ nativeModule()
...
const FfiConverterTypeHOTP = (() => {
  ...
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    ...
    allocationSize(value: TypeName): number {
      return (
        FfiConverterTypeHOTPOptions.allocationSize(value.options) +
...
export const HotpOptions = (() => {
  const defaults = () => ({});
  const create = (() => {
    return uniffiCreateRecord<HotpOptions, ReturnType<typeof defaults>>(
      defaults,
    );
  })();
  return Object.freeze({
...
export const Mfkdf2DerivedKey = (() => {
  const defaults = () => ({});
  const create = (() => {
    return uniffiCreateRecord<Mfkdf2DerivedKey, ReturnType<typeof defaults>>(
      defaults,
    );
  })();
  return Object.freeze({
...
const FfiConverterTypeMFKDF2DerivedKey = (() => {
  ...
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    ...
    allocationSize(value: TypeName): number {
      return (
        FfiConverterTypePolicy.allocationSize(value.policy) +
...
export const Mfkdf2Entropy = (() => {
  const defaults = () => ({});
  const create = (() => {
    return uniffiCreateRecord<Mfkdf2Entropy, ReturnType<typeof defaults>>(
      defaults,
    );
  })();
  return Object.freeze({
...
const FfiConverterTypeMFKDF2Entropy = (() => {
  ...
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    ...
    allocationSize(value: TypeName): number {
      return (
        FfiConverterUInt32.allocationSize(value.real) +
...
export const Mfkdf2Factor = (() => {
  const defaults = () => ({});
  const create = (() => {
    return uniffiCreateRecord<Mfkdf2Factor, ReturnType<typeof defaults>>(
      defaults,
    );
  })();
  return Object.freeze({
...
export const Mfkdf2Options = (() => {
  const defaults = () => ({});
  const create = (() => {
    return uniffiCreateRecord<Mfkdf2Options, ReturnType<typeof defaults>>(
      defaults,
    );
  })();
  return Object.freeze({
...
export const PasswordOptions = (() => {
  const defaults = () => ({});
  const create = (() => {
    return uniffiCreateRecord<PasswordOptions, ReturnType<typeof defaults>>(
      defaults,
    );
  })();
  return Object.freeze({
...
export const PolicyFactor = (() => {
  const defaults = () => ({});
  const create = (() => {
    return uniffiCreateRecord<PolicyFactor, ReturnType<typeof defaults>>(
      defaults,
    );
  })();
  return Object.freeze({
...
export const FactorType = (() => {
  ...
  class Password_ extends UniffiEnum implements Password__interface {
    ...
    readonly inner: Readonly<[Password]>;
  ...
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      switch (ordinalConverter.read(from)) {
        case 1:
          return new FactorType.Password(FfiConverterTypePassword.read(from));
        case 2:
          return new FactorType.Hotp(FfiConverterTypeHOTP.read(from));
        default:
...
const FfiConverterTypeHOTPHash = (() => {
  ...
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      switch (ordinalConverter.read(from)) {
        case 1:
          return HotpHash.Sha1;
        case 2:
          return HotpHash.Sha256;
        case 3:
          return HotpHash.Sha512;
        default:
          throw new UniffiInternalError.UnexpectedEnumCase();
      }
    }
    write(value: TypeName, into: RustBuffer): void {
      switch (value) {
        ...
        case HotpHash.Sha256:
          return ordinalConverter.write(2, into);
        case HotpHash.Sha512:
  ...
  class FfiConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      switch (intConverter.read(from)) {
        case 1:
          return new Mfkdf2Error.PasswordEmpty(FfiConverterString.read(from));

        case 2:
          return new Mfkdf2Error.AnswerEmpty(FfiConverterString.read(from));

        case 3:
          return new Mfkdf2Error.InvalidThreshold(
            FfiConverterString.read(from),
          );

        case 4:
          return new Mfkdf2Error.MissingFactorId(FfiConverterString.read(from));

        case 5:
          return new Mfkdf2Error.DuplicateFactorId(
            FfiConverterString.read(from),
          );

        case 6:
          return new Mfkdf2Error.DecodeError(FfiConverterString.read(from));

        case 7:
          return new Mfkdf2Error.TryFromVecError(FfiConverterString.read(from));

        case 8:
          return new Mfkdf2Error.ShareRecoveryError(
            FfiConverterString.read(from),
          );

        case 9:
          return new Mfkdf2Error.InvalidHmacKey(FfiConverterString.read(from));

        case 10:
          return new Mfkdf2Error.InvalidHotpDigits(
            FfiConverterString.read(from),
          );

        case 11:
          return new Mfkdf2Error.Argon2Error(FfiConverterString.read(from));

        case 12:
          return new Mfkdf2Error.SerializeError(FfiConverterString.read(from));
...
const FfiConverterMapStringTypeMFKDF2Factor = new FfiConverterMap(
  FfiConverterString,
...
const FfiConverterArrayTypeMFKDF2Factor = new FfiConverterArray(
  FfiConverterTypeMFKDF2Factor,
);

// FfiConverter for Array<PolicyFactor>
const FfiConverterArrayTypePolicyFactor = new FfiConverterArray(
...
function uniffiEnsureInitialized() {
  ...
  const scaffoldingContractVersion =
    nativeModule().ubrn_ffi_mfkdf2_uniffi_contract_version();
  ...
  if (nativeModule().ubrn_uniffi_mfkdf2_checksum_func_derive_key() !== 2663) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      "uniffi_mfkdf2_checksum_func_derive_key",
    );
  }
  if (
    nativeModule().ubrn_uniffi_mfkdf2_checksum_func_derive_password() !== 58970
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      "uniffi_mfkdf2_checksum_func_derive_password",
    );
  }
  if (nativeModule().ubrn_uniffi_mfkdf2_checksum_func_hotp() !== 58788) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      "uniffi_mfkdf2_checksum_func_hotp",
    );
  }
  if (nativeModule().ubrn_uniffi_mfkdf2_checksum_func_key() !== 8066) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      "uniffi_mfkdf2_checksum_func_key",
    );
  }
  if (
    nativeModule().ubrn_uniffi_mfkdf2_checksum_func_setup_password() !== 21577
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      "uniffi_mfkdf2_checksum_func_setup_password",
    );
  }
}
